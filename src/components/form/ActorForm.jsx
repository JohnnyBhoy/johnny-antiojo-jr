...
export default function ActorForm({ title, btnTitle, busy, onSubmit, initialProfile }) {
  ...
  useEffect(() => {
    if (initialProfile) {
      setActorInfo({ ...initialProfile, avatar: null });
      setSelectedAvatarForUI(initialProfile.avatar)
    }
  }, [initialProfile]);
